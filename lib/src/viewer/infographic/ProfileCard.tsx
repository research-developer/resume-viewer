...
export const ProfileCardUI: React.FC<ProfileCardUIProps> = ({
  ...
  return (
    <div className="relative w-full max-w-md mx-auto rounded-card shadow-card overflow-hidden bg-surface border border-border transition-transform duration-300 hover:scale-[1.01] p-4">
      ...
      {/* Low-contrast border edge */}
      <div className="absolute inset-0 rounded-card pointer-events-none border border-border"></div>
    </div>
  );
};
